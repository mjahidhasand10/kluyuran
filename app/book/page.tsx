...
const Book = () => {
  ...
  useEffect(() => {
    if (!user) {
      // If user is not logged in, loading should stop here so redirect can happen
      setLoading(false);
      return;
    }
      ...
      <Row gutter={16}>
        <Col span={6}>
          <Form.Item
            ...
            name={[
              `passenger_${passengerType.toLowerCase()}_${index}`,
              "title",
            ]}
  ...
  const renderPassengerForms = () => {
    ...
    for (let i = 1; i <= adultCount; i++) {
      forms.push(
        <PassengerForm key={`adult-${i}`} passengerType="Adult" index={i} />
      );
    }
    ...
    for (let i = 1; i <= childCount; i++) {
      forms.push(
        <PassengerForm key={`child-${i}`} passengerType="Child" index={i} />
      );
    }
              ...
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center">
                  {flightData.flight.air_logo ? (
                    <img
                      src={flightData.flight.air_logo}
                      alt="Airline"
                      className="w-10 h-10"
                    />
                  ) : (
        ...
        <Col span={8}>
          <Card className="sticky top-6">
            ...
            <div className="mb-6">
              ...
              <div className="bg-blue-50 p-3 rounded mb-2">
                <div className="text-sm font-medium text-blue-800">
                  Arrival: {formatDate(flight.arrivaldate)},{" "}
            ...
            <div className="mb-6">
              {parseInt(searchParams.adults) > 0 && (
                <div className="mb-3">
                  ...
                  <div className="text-sm text-gray-600 ml-4">
                    Base fare:{" "}
                    {Math.floor(flightData.flight.price_info.base * 0.7)}
                  </div>
                  <div className="text-sm text-gray-600 ml-4">
              ...
              {parseInt(searchParams.children) > 0 && (
                <div className="mb-3">
                  ...
                  <div className="text-sm text-gray-600 ml-4">
                    Base fare:{" "}
                    {Math.floor(flightData.flight.price_info.base * 0.5)}
                  </div>
                  <div className="text-sm text-gray-600 ml-4">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {Math.floor(flightData.flight.price_info.base * 0.3)}
                  </span>
                </div>
                <div className="flex justify-between font-bold text-lg">
                  <span>Total Amount</span>
                  <span>
                    {flightData.flight.price_info.currency}{" "}
                    {flightData.flight.price_info.total}
                  </span>
                </div>
              </div>
            </div>
